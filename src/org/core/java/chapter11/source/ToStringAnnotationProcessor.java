...
/**
 * Processor class that generates the source files for the toString() methods.
 */
@SupportedAnnotationTypes("org.core.java.chapter11.source.ToString")
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment currentRound) {
		...
		try {
			JavaFileObject sourceFile = processingEnv.getFiler()
					.createSourceFile("org.core.java.chapter11.source.ToStrings");
			try (PrintWriter out = new PrintWriter(sourceFile.openWriter())) {
				out.println("// Automatically generated by org.core.java.chapter11.source.ToStringAnnotationProcessor");
				out.println("package org.core.java.chapter11.source;");
